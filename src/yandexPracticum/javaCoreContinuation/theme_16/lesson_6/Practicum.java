...
public class Practicum {
    ...
    static class PostsHandler implements HttpHandler {
        ...
        private void handlePostComments(HttpExchange exchange) throws IOException {
            ...
            try {
                postId = Integer.parseInt(pathParts[2]);
            ...
            try (InputStream input = exchange.getRequestBody()) {
                commentJson = new String(input.readAllBytes(), DEFAULT_CHARSET);
                comment = new Gson().fromJson(commentJson, Comment.class);
            ...
            if (user == null || user.isEmpty() || text == null || text.isEmpty()) {
